...
public class StatusCodes {
	...
	public static final int NO_USERNAME = 432;
	public static final int NO_PASSWORD = 433;
	public static final int INVALID_USERNAME = 434;
	public static final int INVALID_PASSWORD = 435;
	public static final int TOKEN_MISSING = 436;
	public static final int TOKEN_INVALID = 437;
